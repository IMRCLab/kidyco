...
::: {.callout-note}
When integrating, $\mR$ has to preserve the properties of a rotation matrix.
:::
...
::: {.callout-note}
When integrating, $\vq$ has to preserve the property of a unit quaternion (or an integration method that preservers this has to be used, see @sec-quat-derivative-and-integration).
:::
...
Details are in [@2018-faessler-DifferentialFlatnessQuadrotor] (Appendix A).
...
This controller was proposed in (@2010-lee-geometricTrackingControl).
...
Commercially off-the-shelves (Cots) robot: [Crazyflie 2.1](https://www.bitcraze.io/products/old-products/crazyflie-2-1/)
...
\end{bmatrix}\\
\kappa_F &= 2.023532265845548e-08\\
\kappa_\tau &= 1.214119359507329e-10\\
a &= \frac{1}{\sqrt 2} 0.046 m\\
\mJ &= \begin{bmatrix}
16.571710e-6 & 0 & 0\\
0 & 16.655602e-6 & 0\\
0 & 0 & 29.261652e-6
...
<!-- https://github.com/quimortiz/dynobench/blob/main/models/quad3d_v0.yaml -->

Identical to "crazyflie-21", but with additional state space bounds (@hoenig2022dbAstar; @2024-ortiz-haro-IDbAIterativeSearch):
...
Here the action space is directly force/torque, i.e., $(f,\vtau_u)^\top \in \sU$. This dramatically simplifies planning and is used, for example in [OMPL.APP](https://github.com/ompl/omplapp/blob/main/src/omplapp/apps/QuadrotorPlanning.cpp)
...
<!-- https://github.com/quimortiz/dynobench/blob/main/models/quad3d_omplapp.yaml -->

Similar to "quad3d_v2", but with different bounds. This appeared in (@2024-ortiz-haro-IDbAIterativeSearch) as "Quadrotor v1".
...
Commercially off-the-shelves (Cots) robot: [Crazyflie 2.1+](https://www.bitcraze.io/products/crazyflie-2-1-plus/)

<!-- 
python3 estimate_kw_from_thruststand.py data/cf21plus/data_feb_24_2026_350mah_battery1.csv data/cf21plus/data_feb_24_2026_350mah_battery0.csv data/cf21plus/data_feb_24_2026_250mah_battery0.csv  -->

$$
\begin{aligned}
\sU &= [1370, 3390]^4 rad/s\\
N &= 4\\
m &= 0.034 kg\\
\mB &=
\begin{bmatrix}
...
-\kappa_\tau & \kappa_\tau & -\kappa_\tau & \kappa_\tau
\end{bmatrix}\\
\kappa_F &= 1.4346289961914151e-08\\
\kappa_\tau &= 1.0032209789778871e-10\\
a &= \frac{1}{\sqrt 2} 0.046 m\\
\mJ &= \begin{bmatrix}
16.571710e-6 & 0 & 0\\
0 & 16.655602e-6 & 0\\
...
### crazyflie-21brushless

Commercially off-the-shelves (Cots) robot: [Crazyflie 2.1 Brushless](https://www.bitcraze.io/products/crazyflie-2-1-brushless/)

Model see [@2026-cfbf-model].